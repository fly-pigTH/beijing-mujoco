...
An interactive 3D miniature of Beijing — **52 named landmarks** plus procedural
urban fabric (hutong courtyards, residential & office blocks, ring roads, lakes,
parks) — placed at their real relative geographic positions and rendered **live
in the browser** by the official **MuJoCo WebAssembly** module.
...
- **Click a building** — show the landmark's name (the 52 named bodies)
...
| `names.json` | body-id → landmark name map |
